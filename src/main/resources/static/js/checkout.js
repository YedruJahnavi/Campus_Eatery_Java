...
async function initCheckout() {
    ...
    try {
        ...
        let summaryHtml = '<div style="background: rgba(0,0,0,0.2); padding: 1rem; border-radius: 8px;">';
        ...
        summaryHtml += `
            <div style="border-top: 1px solid var(--border-glass); margin-top: 1rem; padding-top: 0.5rem; display: flex; justify-content: space-between;">
            ...
            <div style="border-top: 1px solid var(--border-glass); padding-top: 1rem; display: flex; justify-content: space-between; font-weight: 700; font-size: 1.2rem; color: var(--accent-primary);">
