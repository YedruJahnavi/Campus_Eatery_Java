        ...
        if (res.ok) {
            ...
            container.innerHTML = requests.map(req => `
                <tr>
                    ...
                    <td>
                        <button class="btn btn-dark btn-sm" onclick="approveVendor('${req.user.id}')">
                            Approve Vendor
                        </button>
                    </td>
                </tr>
...
async function loadUsers() {
        ...
        if (res.ok) {
            ...
            container.innerHTML = users.map(u => `
                <tr>
                    ...
                    <td>
                        <button class="btn btn-outline btn-sm" onclick="toggleUserStatus('${u.id}', ${u.isActive === false})">
    ...
    container.innerHTML = `
        <tr>
            ...
            <td><button class="btn btn-outline btn-sm" disabled>System Admin</button></td>
        </tr>
        <tr>
            <td><code>vendor_demo_1</code></td>
            <td>spicybyte@campus.edu</td>
            <td><span class="pill">VENDOR</span></td>
            <td><span>Active</span></td>
            <td><button class="btn btn-outline btn-sm">Disable</button></td>
        </tr>
    `;
}
